...
import 'package:education_app/subjectname.dart';
...
class CbseDashboard extends StatefulWidget {
  @override
  _CbseDashboardState createState() => _CbseDashboardState();
}

class _CbseDashboardState extends State<CbseDashboard> {
  @override
              ...
              Card(
                ...
                child: InkWell(
                  onTap:(){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => subjectdashboard()));
                  },
