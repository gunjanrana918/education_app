...
import 'package:education_app/mpboardsubject.dart';
...
class MpDashboard extends StatefulWidget {
  @override
  _MpDashboardState createState() => _MpDashboardState();
}
            ...
            Card(
              ...
              child: InkWell(
                onTap:()
                {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => mpsubject()));
                  },
