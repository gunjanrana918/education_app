...
import 'Nodecbsesubject.dart';
import 'mpbuynow.dart';

void main()=> runApp(MaterialApp(
  debugShowCheckedModeBanner: false,
  home: subjectdashboard(),
));
...
{
  List<Nodecbsesubject> _nodes=List<Nodecbsesubject>();
  Future <List<Nodecbsesubject>> getdata() async {
    var req = await http.get('http://ankushapp.iotans.in/api/get_subject_by_class/?boardname=CBSE&classname='+universaldata.SelectedClassname);
    // var nodes = {new Node("neeraj", "ok"),new Node("Radhe", "ok")};
    // print(universaldata.sname);
    List<Nodecbsesubject> nodes=List<Nodecbsesubject>();
    ...
    for (var nodeJson in nodesJson) {
      ...
      nodes.add(new Nodecbsesubject(Subjectid,
          BoardName,
          classname,
          SubjectName,
          Description,
